...
public class OccupantMedicalDetailsFactory {
    ...
    public static OccupantMedicalDetails createOccupantMedicalDetails(String ailmentID, String occupantID, int height, int weight, GregorianCalendar dateOfBirth){
