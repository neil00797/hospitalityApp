...
@RestController
@RequestMapping("/occupantmedicaldetails")
public class OccupantMedicalDetailsController {
    ...
    public OccupantMedicalDetails create (@RequestBody OccupantMedicalDetails occupantMedicalDetails){
        ...
        OccupantMedicalDetails newOccupantMedicalDetails= OccupantMedicalDetailsFactory.createOccupantMedicalDetails(occupantMedicalDetails.getAilment(),occupantMedicalDetails.getOccupantID(),occupantMedicalDetails.getHeight(),occupantMedicalDetails.getWeight(),occupantMedicalDetails.getDateOfBirth());
